<!--/**
 * fees waiver configuration
 *
 * @author	s.m. monjurul islam (https://www.facebook.com/islam.rasel)
 */-->

<h2>Configure Waiver Student Wise</h2>
<hr/>
<form class="form-horizontal" method="post" action="">
  ...
  <div class="form-group">
        ...
        <div class="col-sm-7">
          <select class="form-control"  id="class_struct" name="class_struct"  required onchange="students_by_class_structure_()" >
...
function students_by_class_structure_()
{
	$("#students_by_class").html("<h2>loading...</h2>");	
	var class_struct_id = $('#class_struct').val();	
	$.ajax({		
		 url:  "<?php echo site_url("fee/ajax_students_by_class_structure_for_fee_waiver")?>/"+class_struct_id,		
		 success: function(html){
