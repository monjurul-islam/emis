<!--/**
 * group Privileges view
 *
 * This view takes all data of group Privileges table and parse in this view as necessary
 *
 * @author	s.m. monjurul islam (https://www.facebook.com/islam.rasel)
 */-->

<h2>Group Privileges : <strong><?php echo $this->m_common->get_groupname_by_id($group_id).'('.$group_id.')';?></strong></h2>
<hr/>
				...
				<div class="panel-heading" role="tab" id="heading'.$qry_modules_res->id.'">
				  <h4 class="panel-title"> 
					<label class="checkbox-inline" >';			
					  if($this->m_priv->priv_module_by_group($qry_modules_res->id, $group_id)==TRUE)
						...
						if($qry_features_res->module_id == $qry_modules_res->id)
						{
							...
							echo '  <div class="checkbox">
									  <label>';
										 ...
										 if($this->m_priv->priv_feature_by_group($qry_features_res->id, $group_id)==TRUE)
