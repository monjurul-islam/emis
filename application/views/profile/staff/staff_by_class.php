...
<form id="staff_form" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>profile/add_staff" >
  <div class="row" style="background:mediumturquoise;">
    <div class="col-md-12">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-3">
          <label for="staff_pic">Staff's Picture</label>
          <input type="file" id="staff_pic" name="staff_pic"  required>
        </div>
      </div>
      <div class="form-group">
  ...
  <div class="row" style="background:powderblue;">
    <div class="col-md-12">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-2">
          <input type="text" id="timeFrom" name="start_time" class="form-control" placeholder="8.00 AM">
        </div>
        <label class=" col-sm-1 control-label" style="width:20px !important;">To</label>
        <div class="col-sm-2">
          <input type="text" id="timeTo" name="end_time" class="form-control" placeholder="8.00 PM">
        </div>
      </div>
      <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="submit" class=" btn btn-lg btn-success" id="add_employee_submit" name="add_employee_submit" value="Add Employee" placeholder="Add Employee">
    </div>
  </div>
</form>
